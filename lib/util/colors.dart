...
class AppColors {
  //static makes varible avible in the entire project
  //AppColors.MyColor
  ...
  static final Color buttonBackaroundcolor = Color.fromARGB(255, 231, 231, 231);
  static final Color signColor = const Color(0xEFa2a22f);
