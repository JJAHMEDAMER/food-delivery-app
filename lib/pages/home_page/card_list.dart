      ...
      child: Column(
        children: [
          ...
          ListView.builder(
            ...
            shrinkWrap: true, // No Need for container
            itemCount: 10,
            itemBuilder: (context, index) {
              return Container(
                child: Row(
                  crossAxisAlignment:
                      CrossAxisAlignment.center, // Default Behavior but anyways
                  children: [
                    Container(
                    ...
                    Expanded(
                      ...
                      child: Container(
                        ...
                        margin: EdgeInsets.only(
                            top: Dimensions
                                .height15), // must have matching margin with the image container to properly algin
